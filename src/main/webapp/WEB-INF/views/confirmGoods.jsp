    	...
    	<div class="f-r">
            <div class="confirmation">
                ...
                <div class="commodity" style="border-bottom:0;">
                    ...
                    <div class="matong f-l">
                        ...
                        <p class="pt">${fn:substring(orderItemExt.product.pdesc,0 ,15 )}...</p>
                        <dl>
                            <dt>价格</dt>
                            <dd><span class="sp2">¥ ${orderItemExt.product.shopprice}</span></dd>
                            <div style="clear:both;"></div>
                        </dl>
                    </div>
            ...
            <div class="confirmation">
                ...
                <div class="odr-cf">
                	...
                	<p>成交时间：<fmt:formatDate value="${orderExt.ordertime}" pattern="yyyy-MM-dd HH:mm:ss"/></p>
            ...
            <div class="confirmation">
                ...
                <div class="odr-sh">
                    ...
                    <div class="zfb">
                        ...
                        <button class="zfb-btn" onclick="window.location.href='${pageContext.request.contextPath}/order/toMyOrders.do'">确认</button>
                    </div>
                </div>
            </div>
        </div>
