	...
	<div class="sign-con w1200">
        <img src="${pageContext.request.contextPath}/images/logn-tu.gif" class="sign-contu f-l" />
            ...
            <div class="sign-ipt f-l">
                <p>用户名</p>
                <input type="text" id="userName" name="userName" value="${cookie.userName.value}" placeholder="手机号/邮箱" />
                <p>密码</p>
                <input type="text" id="passWord" name="passWord" value="${cookie.passWord.value}" placeholder="密码可见" /><br />
                <span >${requestScope.msg}</span><br>
                <input type="checkbox" name="save" style="height:12px " ${cookie.passWord.value?"": checked}>记住密码
