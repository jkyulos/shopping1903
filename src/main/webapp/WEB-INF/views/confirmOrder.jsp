    ...
    <form action="${pageContext.request.contextPath}/order/toPay.do" method="post">
        <div class="payment-interface w1200">
            <div class="pay-info">
                ...
                <table>
                    <tr><td>收货人:</td><td><input type="text" name="name" value="${user.name}" required></td></tr>
                    <tr><td>收货地址:</td><td><input type="text" name="addr" value="${user.addr}" required></td></tr>
                    <tr><td>联系方式:</td><td><input type="tel" name="phone" value="${user.phone}" required></td></tr>
                </table>
            </div>
            <div class="pay-info">
                ...
                <c:forEach items="${cart.cartItems}" var="cartItem">
                    <div class="info-mid">
                        <div class="mid-tu f-l">
                            <a href="#"><img width="80px" src="${pageContext.request.contextPath}/${cartItem.product.image}" /></a>
                        </div>
                        <div class="mid-font f-l" style="margin-right:40px; width: 232px;height: 42px">
                        ...
                        <div class="mid-sl f-l" style="margin:10px 54px 0px 0px; width: 121px">
                            <p style="margin-left: 50px">X ${cartItem.count} </p>
                        </div>
